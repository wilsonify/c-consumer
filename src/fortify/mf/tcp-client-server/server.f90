program server
  ...
  use iso_c_binding, only: &
          c_char, c_int, c_int64_t, c_null_char, c_size_t, c_carriage_return, c_new_line
  use mod_dill, only: &
          ipaddr, ipaddr_local, ipaddr_port, ipaddr_str, IPADDR_MAXSTRLEN, IPADDR_IPV4, &
          tcp_accept, tcp_close, tcp_listen, msend, suffix_attach, suffix_detach
